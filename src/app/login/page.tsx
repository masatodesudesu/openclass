                ...
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 overflow-y-auto h-full w-full" id="my-modal">
                    <div className="relative top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-white pt-8 pb-6 rounded-lg shadow-lg w-1/3">
                        <div className="text-center">
                            <p className="mb-6">メールアドレスまたはパスワードが間違っています</p>
            ...
            <div>
                <form onSubmit={handleSubmit} className="flex flex-col items-center">
                    <div className="flex border-2 border-green-700 p-1 mb-8 rounded-full font-bold text-lg">
                        ...
                        <div className="px-14">Googleでログイン</div>
                    </div>
                    ...
                    <div className="flex items-center mb-4 border-b-2 border-green-700 pb-1">
                    ...
                    <Link href="/" className="w-full">
                        <div className="w-full text-end pl-2 mb-10 text-xs">パスワードを忘れた場合</div>
                    </Link>
                    <input type='submit'
                        value='ログイン'
                    ...
                    />
                    <Link href="/signup">
                        <div className="text-xs text-green-700 border-b border-green-700">アカウントをお持ちでない方はこちら</div>
                    </Link>
                </form>
            </div>
        </div>
